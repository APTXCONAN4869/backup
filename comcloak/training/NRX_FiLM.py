...
model_weights_path = "./comcloak/training/weights/Receiver_sys_weights_v7" # Location to save the neural receiver weights once training is done
train_log_path = "./comcloak/training/train_log/nrx_log/RX_log_v7_ResFiLM_correct.txt"
############################################
...
np.save("/home/wzs/Project/sionna-main/comcloak/training/results/data/CDL-C_early_stop_ber_film.npy", results)
data = np.load("/home/wzs/Project/sionna-main/comcloak/training/results/data/CDL-C_early_stop_ber_film.npy", allow_pickle=True).item()
...
plt.legend()
plt.tight_layout()
plt.savefig("/home/wzs/Project/sionna-main/comcloak/training/results/CDL-C_early_stop_ber_film.png")
plt.close()
