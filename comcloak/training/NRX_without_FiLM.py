...
model_weights_path = "./comcloak/training/weights/Receiver_sys_weights_v10_without_FiLM_3Res" # Location to save the neural receiver weights once training is done
train_log_path = "./comcloak/training/train_log/nrx_log/RX_log_without_FiLM_3Resv10.txt"
############################################
...
class E2ESystem(Model):
    ...
    def call(self, ebno_db):
        ...
        if "baseline" in self._system:
            ...
            llrs = self._receiver_sys([y, no_shuffled])# Feeding the noise power in log10 scale helps with the performance
...
np.save("/home/wzs/Project/sionna-main/comcloak/training/results/data/CDL-C_ber_without_film3Res.npy", results)
data = np.load("/home/wzs/Project/sionna-main/comcloak/training/results/data/CDL-C_ber_without_film3Res.npy", allow_pickle=True).item()
...
plt.legend()
plt.tight_layout()
plt.savefig("/home/wzs/Project/sionna-main/comcloak/training/results/CDL-C_ber_without_film_3Resmc.png")
plt.close()