...
model_weights_path = "./comcloak/training/weights/Receiver_sys_weights_v0" # Location to save the neural receiver weights once training is done
train_log_path = "./comcloak/training/train_log/nrx_log/RX_log_v0_batch_var_snr.txt"
############################################
...
N_MC = 3        # Monte Carlo 次数（20~100 都可以）
results = {
    "ebno_db": [],
    "ber1": [],
    "ber2": [],
...
np.save("/home/wzs/Project/sionna-main/comcloak/training/results/data/CDL-C_ber_condconv.npy", results)
data = np.load("/home/wzs/Project/sionna-main/comcloak/training/results/data/CDL-C_ber_condconv.npy", allow_pickle=True).item()
...
plt.legend()
plt.tight_layout()
plt.savefig("/home/wzs/Project/sionna-main/comcloak/training/results/CDL-C_ber_condconv_mc.png")
plt.close()
